...
class Dilli {
    ...
    public Dilli(int id, String name, String email) {
        this.id = id;
        this.name = name;
        this.email = email;
    }
...
class EmployeePool {
    ...
    public synchronized Dilli acquire() {
        if (employees.isEmpty()) {
            return new Dilli();
        }
        Dilli e = employees.iterator().next();
        employees.remove(e);
        return e;
    }

    public synchronized void release(Dilli e) {
...
public class ObjectPooldp{
	public static void main(String[] args) {
	    ...
	    Dilli e1 = pool.acquire();
	    Dilli e2 = pool.acquire();
	    Dilli e3 = pool.acquire();
	    ...
	    Dilli e4 = pool.acquire();
	    Dilli e5 = pool.acquire();
	    Dilli e6 = pool.acquire();
	    Dilli e7 = pool.acquire();

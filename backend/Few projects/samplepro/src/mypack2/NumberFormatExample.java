...
public class NumberFormatExample {
	public static void main(String[] args) {
		...
		nf.setMaximumFractionDigits(3);                             //NumberFormat nf =NumberFormat.getInstance();
		...
		double d=123456.789;
		Locale INDIA=new Locale("pa","IN");    //deprecated it will not support the furture version
